    ...
    <div className="min-h-screen flex flex-col bg-[#f0f7f4] font-sans text-slate-800">
      ...
      <div className="print:hidden flex flex-col flex-1">
        ...
        <header className="bg-[#0f766e] text-white pt-8 pb-6 px-4 text-center shadow-sm relative">
          ...
          <p className="text-emerald-100 font-medium text-xs md:text-sm mt-1">
            วิชา: <span className="font-bold text-white">{courseInfo?.courseCode || 'กำลังโหลด...'}  </span> {courseInfo?.courseName ? `${courseInfo.courseName}` : ''}
          </p>
        </header>
      ...
      <CourseAttendanceSheetPrintForm
        courseInfo={{
          ...
          teacherName: courseInfo?.teacher?.name || courseInfo?.teacherDisplayName || 'อาจารย์ผู้สอน',
